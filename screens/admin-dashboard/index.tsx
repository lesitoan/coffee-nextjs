    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/admin/posts/new" className="rounded-xl bg-coffee-700 px-5 py-3 text-sm font-bold text-white transition hover:bg-coffee-800">
            New Post
          </Link>
          <Link href="/admin/categories/new" className="rounded-xl border border-stone-300 px-5 py-3 text-sm font-bold text-stone-700 transition hover:border-coffee-700 hover:text-coffee-700">
            New Category
          </Link>
        </div>
      </div>
