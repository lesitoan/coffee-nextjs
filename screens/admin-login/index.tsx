    ...
    <section className="min-h-screen bg-stone-100 pb-20 pt-32">
      <div className="section-shell">
        <div className="mx-auto max-w-md rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
          ...
          <a href="/api/auth/signin?callbackUrl=/admin" className="inline-flex w-full justify-center rounded-xl bg-stone-900 px-5 py-3 font-bold text-white transition hover:bg-coffee-800">
